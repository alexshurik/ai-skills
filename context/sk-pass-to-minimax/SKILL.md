---
name: sk-pass-to-minimax
version: 1.0.0
description: Save context and switch to mclaude in a new tab
license: MIT
...
Open mclaude in a new tab with detailed context passed as argument.
...
### 2. Open new tab and launch mclaude with context as argument
...
tell application "System Events"
    ...
    delay 0.2
    keystroke "cd $(pwd) && mclaude '[ESCAPED_CONTEXT]'"
    keystroke return
end tell
EOF
```
...
```bash
echo "cd $(pwd) && mclaude '[ESCAPED_CONTEXT]'" | pbcopy
```

### 3. Tell the user

If worked: "Done! mclaude opening with context."
